      ...
      data.items.forEach(item => {
        ...
        itemdiv.innerHTML = `
                  ...
                  <div>
                      ...
                      <img src="${item.itemImageURL}" alt="${item.itemName}" class=" absolute inset-0 object-cover rounded-lg lg:h-full lg:w-full  ">
                      
                     <div class=" absolute inset-0   text-white  opacity-100 lg:opacity-0 lg:hover:opacity-100 transition-opacity duration-300">
